...
const P_IITs = () => {
  ...
  return (
    <div className=' relative w-[100vw] min-h-[60vh] mb-8  border-b-[4px] border-[rgb(173,173,173)] flex flex-col justify-center items-center'>
      
      <fieldset >
      <legend className='md:text-[50px] sm:text-[40px] text-[30px]  md:px-[75px] px-[20px]' >Participating IITs</legend></fieldset>
    <Slider {...settings} className='w-[80vw] overflow-visible'>
      {IITs.map((iit, index) => (
        <div key={index} className='img flex flex-col justify-center items-center'>
          <div className='w-[200px] h-[200px] bg-white shadow-2xl rounded-full flex justify-center items-center'>

          <img src={iit.img} alt={iit.name} className='w-[150px] h-[150px] object-contain'/>
          </div>
