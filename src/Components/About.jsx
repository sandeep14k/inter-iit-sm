...
const About = () => {
  return (
    <div className="w-[100vw] py-10 bg-[#242424] flex lg:flex-row flex-col lg:justify-between items-center">
      <div className="md:w-[40vw] flex justify-center items-center md:h-[30vw] w-[100vw] h-[30vh] relative ">
        <img
          src="../../About/about.svg"
          alt=""
      ...
      <div className="lg:w-[50vw] w-[95vw] flex flex-col lg:items-end items-center lg:pr-[100px] text-white">
        ...
        Preparation for the inter IITs starts way before the event with hundreds of students involved in the success of the event
        </div>
      </div>
    </div>
  );
